...
//! `rgb_gray_to_devicegray` and `preserve_black`
...
//! serialisation: an RGB grey under `rgb_gray_to_devicegray: true`
...
fn settings_with_options(rgb_gray_to_devicegray: bool, preserve_black: bool) -> SerializeSettings {
    SerializeSettings {
        rgb_gray_to_devicegray,
        preserve_black,
        ..settings_1()
    }
}
...
#[test]
fn rgb_gray_to_devicegray_promotes_when_set() {
