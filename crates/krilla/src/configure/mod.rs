...
pub use validate::{
    Accessibility, Archival, Prepress, ValidationError, Validator, Validators, VersionedFeature,
};
...
pub enum ConfigurationError {
    ...
    /// key (ISO 15930-4 §6.2.2, ISO 15930-7 §6.4.2.1), and PDF/A permits several
