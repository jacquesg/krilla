...
//!   `/JS` entry per ISO 32000-2 §12.6.4.16. Typical use is the
...
pub enum Action {
    ...
    /// when triggered (ISO 32000-2 §12.6.4.16). The script string is
...
/// ECMAScript snippet when triggered (ISO 32000-2 §12.6.4.16).
///
